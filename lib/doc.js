...
module.exports = class Doc {
  constructor (props) {
    ...
    // Add custom redirects to frontmatter, if any exist
    if (this.redirects.length) this.frontmatter.redirect_from = this.redirects
  ...
  get redirects () {
    return require('./redirects')[this.permalink] || []
  }
