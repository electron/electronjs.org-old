We are pleased to announce that version 1.0 of Electron, the framework
...
apps. [Devtron][devtron] is an open-source extension to the Chrome Developer
Tools designed to help you inspect, debug, and troubleshoot your Electron app.
