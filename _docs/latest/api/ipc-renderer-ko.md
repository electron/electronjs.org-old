...
만약 랜더러 프로세스에서 메인 프로세스의 모듈을 직접적으로 사용하고 싶다면 [remote](http://electron.atom.io/docs/v0.30.1/api/remote-ko) 모듈을 사용하는 것을 고려해보는 것이 좋습니다.

[ipc (main process)](http://electron.atom.io/docs/v0.30.1/api/ipc-main-process-ko)에서 예제를 볼 수 있습니다.
