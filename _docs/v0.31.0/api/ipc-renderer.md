...
process, you might consider using the [remote](http://electron.atom.io/docs/v0.31.0/api/remote) module.

See [ipc (main process)](http://electron.atom.io/docs/v0.31.0/api/ipc-main-process) for examples.
