...
[native modules](http://electron.atom.io/docs/v0.31.0/tutorial/using-native-node-modules)).
...
[main process vs. renderer process](http://electron.atom.io/docs/v0.31.0/tutorial/quick-start#the-main-process)
...
To run your app, read [Run your app](http://electron.atom.io/docs/v0.31.0/tutorial/quick-start#run-your-app).
