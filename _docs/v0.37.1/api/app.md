...
Emitted when a [browserWindow](http://electron.atom.io/docs/v0.37.1/api/browser-window) gets blurred.
...
Emitted when a [browserWindow](http://electron.atom.io/docs/v0.37.1/api/browser-window) gets focused.
...
Emitted when a new [browserWindow](http://electron.atom.io/docs/v0.37.1/api/browser-window) is created.
...
* `menu` [Menu](http://electron.atom.io/docs/v0.37.1/api/menu)
