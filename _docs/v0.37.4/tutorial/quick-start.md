...
renderer processes. Like [`ipcRenderer`](http://electron.atom.io/docs/v0.37.4/api/ipc-renderer) and
[`ipcMain`](http://electron.atom.io/docs/v0.37.4/api/ipc-main) modules for sending messages, and the
[remote](http://electron.atom.io/docs/v0.37.4/api/remote) module for RPC style communication. There is also
...
following the [Application Distribution](http://electron.atom.io/docs/v0.37.4/tutorial/application-distribution) guide
...
[share-data]: http://electron.atom.io/docs/v0.37.4/faq/electron-faq#how-to-share-data-between-web-pages
