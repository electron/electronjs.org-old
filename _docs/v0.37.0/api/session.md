...
property of [`webContents`](http://electron.atom.io/docs/v0.37.0/api/web-contents) which is a property of
[`BrowserWindow`](http://electron.atom.io/docs/v0.37.0/api/browser-window).
...
* `event` Event
* `item` [DownloadItem](http://electron.atom.io/docs/v0.37.0/api/download-item)
...
* `handler` Function
  * `webContents` Object - [WebContents](http://electron.atom.io/docs/v0.37.0/api/web-contents) requesting the permission.
