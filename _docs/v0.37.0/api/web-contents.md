...
the [`BrowserWindow`](http://electron.atom.io/docs/v0.37.0/api/browser-window) object. An example of accessing the
`webContents` object:
...
The usage is the same with [the `login` event of `app`](http://electron.atom.io/docs/v0.37.0/api/app#event-login).
...
[`webContents.findInPage`](http://electron.atom.io/docs/v0.37.0/api/web-contents#webcontentsfindinpage) request.
...
obtained by subscribing to [`found-in-page`](http://electron.atom.io/docs/v0.37.0/api/web-contents#event-found-in-page) event.

### `webContents.stopFindInPage(action)`

* `action` String - Specifies the action to take place when ending
  [`webContents.findInPage`](http://electron.atom.io/docs/v0.37.0/api/web-contents#webcontentfindinpage) request.
...
* `keyCode` String (**required**) - The character that will be sent
  ...
  [Accelerator](http://electron.atom.io/docs/v0.37.0/api/accelerator).
...
Returns the [session](http://electron.atom.io/docs/v0.37.0/api/session) object used by this webContents.
