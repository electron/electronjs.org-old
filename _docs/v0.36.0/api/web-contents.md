...
the [`BrowserWindow`](http://electron.atom.io/docs/v0.36.0/api/browser-window) object. An example of accessing the
`webContents` object:
...
The usage is the same with [the `login` event of `app`](http://electron.atom.io/docs/v0.36.0/api/app#event-login).
...
Returns the [session](http://electron.atom.io/docs/v0.36.0/api/session) object used by this webContents.
