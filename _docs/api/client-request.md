...
redirect_from:
    ...
    - /docs/v0.29.0/api/client-request/
    - /docs/v0.30.0/api/client-request/
    - /docs/v0.31.0/api/client-request/
    - /docs/v0.32.0/api/client-request/
    - /docs/v0.33.0/api/client-request/
    - /docs/v0.34.0/api/client-request/
    - /docs/v0.35.0/api/client-request/
    ...
    - /docs/v0.37.2/api/client-request/
