...
title: Docs
redirect-from:
    - 'http://electron.atom.io/docs/v0.24.0/api/menu/'
    - 'http://electron.atom.io/docs/v0.25.0/api/menu/'
    - 'http://electron.atom.io/docs/v0.26.0/api/menu/'
    - 'http://electron.atom.io/docs/v0.27.0/api/menu/'
    - 'http://electron.atom.io/docs/v0.28.0/api/menu/'
    - 'http://electron.atom.io/docs/v0.29.0/api/menu/'
    - 'http://electron.atom.io/docs/v0.30.0/api/menu/'
    - 'http://electron.atom.io/docs/v0.31.0/api/menu/'
    - 'http://electron.atom.io/docs/v0.32.0/api/menu/'
    - 'http://electron.atom.io/docs/v0.33.0/api/menu/'
    - 'http://electron.atom.io/docs/v0.34.0/api/menu/'
    - 'http://electron.atom.io/docs/v0.35.0/api/menu/'
    - 'http://electron.atom.io/docs/v0.36.0/api/menu/'
    - 'http://electron.atom.io/docs/v0.36.3/api/menu/'
    - 'http://electron.atom.io/docs/v0.36.4/api/menu/'
    - 'http://electron.atom.io/docs/v0.36.5/api/menu/'
    - 'http://electron.atom.io/docs/v0.36.6/api/menu/'
    - 'http://electron.atom.io/docs/v0.36.7/api/menu/'
    - 'http://electron.atom.io/docs/v0.36.8/api/menu/'
    - 'http://electron.atom.io/docs/v0.36.9/api/menu/'
    - 'http://electron.atom.io/docs/v0.36.10/api/menu/'
    - 'http://electron.atom.io/docs/v0.36.11/api/menu/'
    - 'http://electron.atom.io/docs/v0.37.0/api/menu/'
    - 'http://electron.atom.io/docs/v0.37.1/api/menu/'
    - 'http://electron.atom.io/docs/v0.37.2/api/menu/'
    - 'http://electron.atom.io/docs/v0.37.5/api/menu/'
...
Each menu consists of multiple [menu items](http://electron.atom.io/docs/v0.37.5/api/menu-item) and each menu item can
have a submenu.

Below is an example of creating a menu dynamically in a web page
(render process) by using the [remote](http://electron.atom.io/docs/v0.37.5/api/remote) module, and showing it when
...
[MenuItem](http://electron.atom.io/docs/v0.37.5/api/menu-item). The usage can be referenced above.
