...
Emitted when a [browserWindow](http://electron.atom.io/docs/v0.36.5/api/browser-window) gets blurred.
...
Emitted when a [browserWindow](http://electron.atom.io/docs/v0.36.5/api/browser-window) gets focused.
...
Emitted when a new [browserWindow](http://electron.atom.io/docs/v0.36.5/api/browser-window) is created.
