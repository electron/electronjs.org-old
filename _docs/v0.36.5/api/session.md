...
property of [`webContents`](http://electron.atom.io/docs/v0.36.5/api/web-contents) which is a property of
[`BrowserWindow`](http://electron.atom.io/docs/v0.36.5/api/browser-window).
...
* `event` Event
* `item` [DownloadItem](http://electron.atom.io/docs/v0.36.5/api/download-item)
