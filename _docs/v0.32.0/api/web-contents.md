...
the [`BrowserWindow`](http://electron.atom.io/docs/v0.32.0/api/browser-window) object. An example of accessing the
`webContents` object:
...
See [session documentation](http://electron.atom.io/docs/v0.32.0/api/session) for this object's methods.
