...
Returns the content in clipboard as [NativeImage](http://electron.atom.io/docs/v0.25.0/api/native-image).

## clipboard.writeImage(image[, type])

* `image` [NativeImage](http://electron.atom.io/docs/v0.25.0/api/native-image)
* `type` String
