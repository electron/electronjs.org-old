...
[`menu`](http://electron.atom.io/docs/v0.37.6/api/menu).

See [`menu`](http://electron.atom.io/docs/v0.37.6/api/menu) for examples.
...
* `options` Object
  ...
  * `icon` [NativeImage](http://electron.atom.io/docs/v0.37.6/api/native-image)
