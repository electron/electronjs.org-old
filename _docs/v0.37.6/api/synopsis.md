...
the [native modules](http://electron.atom.io/docs/v0.37.6/tutorial/using-native-node-modules)).
...
the concept of [main process vs. renderer process](http://electron.atom.io/docs/v0.37.6/tutorial/quick-start#the-main-process) scripts to be
...
To run your app, read [Run your app](http://electron.atom.io/docs/v0.37.6/tutorial/quick-start#run-your-app).
