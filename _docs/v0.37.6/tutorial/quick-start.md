...
renderer processes. Like [`ipcRenderer`](http://electron.atom.io/docs/v0.37.6/api/ipc-renderer) and
[`ipcMain`](http://electron.atom.io/docs/v0.37.6/api/ipc-main) modules for sending messages, and the
[remote](http://electron.atom.io/docs/v0.37.6/api/remote) module for RPC style communication. There is also
...
following the [Application Distribution](http://electron.atom.io/docs/v0.37.6/tutorial/application-distribution) guide
...
[share-data]: http://electron.atom.io/docs/v0.37.6/faq/electron-faq#how-to-share-data-between-web-pages
