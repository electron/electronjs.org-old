...
Emitted when a [browserWindow](http://electron.atom.io/docs/v0.33.0/api/browser-window) gets blurred.
...
Emitted when a [browserWindow](http://electron.atom.io/docs/v0.33.0/api/browser-window) gets focused.
...
Emitted when a new [browserWindow](http://electron.atom.io/docs/v0.33.0/api/browser-window) is created.
...
* `event` Event
* `webContents` [WebContents](http://electron.atom.io/docs/v0.33.0/api/browser-window#class-webcontents)
* `url` String
