...
[`menu`](http://electron.atom.io/docs/v0.36.9/api/menu).

See [`menu`](http://electron.atom.io/docs/v0.36.9/api/menu) for examples.
...
* `options` Object
  ...
  * `label` String
  * `sublabel` String
  * `accelerator` [Accelerator](http://electron.atom.io/docs/v0.36.9/api/accelerator)
