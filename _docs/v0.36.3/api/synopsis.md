...
the [native modules](http://electron.atom.io/docs/v0.36.3/tutorial/using-native-node-modules)).
...
To run your app, read [Run your app](http://electron.atom.io/docs/v0.36.3/tutorial/quick-start#run-your-app).
