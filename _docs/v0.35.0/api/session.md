...
The `session` object is a property of [`webContents`](http://electron.atom.io/docs/v0.35.0/api/web-contents) which is
a property of [`BrowserWindow`](http://electron.atom.io/docs/v0.35.0/api/browser-window). You can access it through an
...
* `event` Event
* `item` [DownloadItem](http://electron.atom.io/docs/v0.35.0/api/download-item)
