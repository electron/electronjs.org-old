...
See [webContents.send](http://electron.atom.io/docs/v0.35.0/api/web-contents#webcontentssendchannel-args) for
examples.
...
See [webContents.sendInputEvent](http://electron.atom.io/docs/v0.35.0/api/web-contents##webcontentssendinputeventevent)
