...
[Frameless Window](http://electron.atom.io/docs/v0.35.0/api/frameless-window) API.
...
* `icon` [NativeImage](http://electron.atom.io/docs/v0.35.0/api/native-image) - The window icon, when omitted on
  Windows the executable's icon would be used as window icon.
* `show` Boolean - Whether window should be shown when created.
* `frame` Boolean - Specify `false` to create a
[Frameless Window](http://electron.atom.io/docs/v0.35.0/api/frameless-window).
...
* `transparent` Boolean - Makes the window [transparent](http://electron.atom.io/docs/v0.35.0/api/frameless-window).
...
* `webContents` [WebContents](http://electron.atom.io/docs/v0.35.0/api/web-contents)
...
See the [`webContents` documentation](http://electron.atom.io/docs/v0.35.0/api/web-contents) for its methods and
events.
...
[NativeImage](http://electron.atom.io/docs/v0.35.0/api/native-image) that stores data of the snapshot. Omitting
...
* `overlay` [NativeImage](http://electron.atom.io/docs/v0.35.0/api/native-image) - the icon to display on the bottom
...
* `icon` [NativeImage](http://electron.atom.io/docs/v0.35.0/api/native-image) - The icon showing in thumbnail
  toolbar.
