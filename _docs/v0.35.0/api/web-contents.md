...
the [`BrowserWindow`](http://electron.atom.io/docs/v0.35.0/api/browser-window) object. An example of accessing the
`webContents` object:
...
The usage is the same with [the `login` event of `app`](http://electron.atom.io/docs/v0.35.0/api/app#event-login).
...
See [session documentation](http://electron.atom.io/docs/v0.35.0/api/session) for this object's methods.
