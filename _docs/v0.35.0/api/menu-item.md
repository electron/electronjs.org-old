...
[`menu`](http://electron.atom.io/docs/v0.35.0/api/menu).

See [`menu`](http://electron.atom.io/docs/v0.35.0/api/menu) for examples.
...
* `options` Object
  ...
  * `label` String
  * `sublabel` String
  * `accelerator` [Accelerator](http://electron.atom.io/docs/v0.35.0/api/accelerator)
