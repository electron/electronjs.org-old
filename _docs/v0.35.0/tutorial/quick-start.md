...
In Electron, we have provided the [ipc](http://electron.atom.io/docs/v0.35.0/api/ipc-renderer) module for
communication between the main process and renderer process. There is also a
[remote](http://electron.atom.io/docs/v0.35.0/api/remote) module for RPC style communication.
...
following the [Application Distribution](http://electron.atom.io/docs/v0.35.0/tutorial/application-distribution) guide
