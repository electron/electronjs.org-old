...
Electron에는 메인 프로세스와 랜더러 프로세스간에 통신을 할 수 있도록 [ipc](http://electron.atom.io/docs/v0.30.0/api/ipc-renderer-ko) 모듈을 제공하고 있습니다.
또한 [remote](http://electron.atom.io/docs/v0.30.0/api/remote-ko) 모듈을 사용하여 RPC 스타일로 통신할 수도 있습니다.
...
앱을 작성한 후 [어플리케이션 배포](http://electron.atom.io/docs/v0.30.0/tutorial/application-distribution-ko) 가이드를 따라 앱을 패키징 하고
