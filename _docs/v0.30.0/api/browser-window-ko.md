...
version: v0.30.0
category: API
title: 'Browser Window Ko'
source_url: 'https://github.com/electron/electron/blob/master/docs/api/browser-window-ko.md'
---
...
[Frameless Window](http://electron.atom.io/docs/v0.30.0/api/frameless-window-ko) API.
...
* `options` Object
  ...
  * `icon` [NativeImage](http://electron.atom.io/docs/v0.30.0/api/native-image-ko) - The window icon, when omitted on
    Windows the executable's icon would be used as window icon
  * `show` Boolean - Whether window should be shown when created
  * `frame` Boolean - Specify `false` to create a
    [Frameless Window](http://electron.atom.io/docs/v0.30.0/api/frameless-window-ko)
  ...
  * `transparent` Boolean - Makes the window [transparent](http://electron.atom.io/docs/v0.30.0/api/frameless-window-ko)
...
[NativeImage](http://electron.atom.io/docs/v0.30.0/api/native-image-ko) that stores data of the snapshot. Omitting the
`rect` would capture the whole visible page.

**Note:** Be sure to read documents on remote buffer in
[remote](http://electron.atom.io/docs/v0.30.0/api/remote-ko) if you are going to use this API in renderer
process.
...
* `overlay` [NativeImage](http://electron.atom.io/docs/v0.30.0/api/native-image-ko) - the icon to display on the bottom
