...
source_url: 'https://github.com/electron/electron/blob/master/docs/api/web-view-tag-ko.md'
---
...
See [WebContents.send](http://electron.atom.io/docs/v0.30.0/api/browser-window-ko#webcontentssendchannel-args) for
examples.
