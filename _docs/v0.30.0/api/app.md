...
Emitted when a [browserWindow](http://electron.atom.io/docs/v0.30.0/api/browser-window) gets blurred.
...
Emitted when a [browserWindow](http://electron.atom.io/docs/v0.30.0/api/browser-window) gets focused.
...
* `event` Event
* `webContents` [WebContents](http://electron.atom.io/docs/v0.30.0/api/browser-window#class-webcontents)
* `url` String
