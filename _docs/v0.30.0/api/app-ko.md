...
category: API
title: 'App Ko'
source_url: 'https://github.com/electron/electron/blob/master/docs/api/app-ko.md'
---
...
Emitted when a [browserWindow](http://electron.atom.io/docs/v0.30.0/api/browser-window-ko) gets blurred.
...
Emitted when a [browserWindow](http://electron.atom.io/docs/v0.30.0/api/browser-window-ko) gets focused.
...
* `event` Event
* `webContents` [WebContents](http://electron.atom.io/docs/v0.30.0/api/browser-window-ko#class-webcontents)
* `url` String
