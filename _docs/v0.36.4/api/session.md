...
property of [`webContents`](http://electron.atom.io/docs/v0.36.4/api/web-contents) which is a property of
[`BrowserWindow`](http://electron.atom.io/docs/v0.36.4/api/browser-window).
...
* `event` Event
* `item` [DownloadItem](http://electron.atom.io/docs/v0.36.4/api/download-item)
