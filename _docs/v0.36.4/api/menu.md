...
Each menu consists of multiple [menu items](http://electron.atom.io/docs/v0.36.4/api/menu-item) and each menu item can
have a submenu.

Below is an example of creating a menu dynamically in a web page
(render process) by using the [remote](http://electron.atom.io/docs/v0.36.4/api/remote) module, and showing it when
...
[MenuItem](http://electron.atom.io/docs/v0.36.4/api/menu-item). The usage can be referenced above.
