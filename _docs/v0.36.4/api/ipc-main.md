...
process, see [webContents.send](http://electron.atom.io/docs/v0.36.4/api/web-contents#webcontentssendchannel-arg1-arg2-) for more information.
...
[webContents.send](http://electron.atom.io/docs/v0.36.4/api/web-contents#webcontentssendchannel-arg1-arg2-) for more information.
