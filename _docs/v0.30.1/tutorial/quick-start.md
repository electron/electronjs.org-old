...
In Electron, we have provided the [ipc](http://electron.atom.io/docs/v0.30.1/api/ipc-renderer) module for
communication between main process and renderer process. And there is also a
[remote](http://electron.atom.io/docs/v0.30.1/api/remote) module for RPC style communication.
...
following the [Application distribution](http://electron.atom.io/docs/v0.30.1/tutorial/application-distribution) guide
