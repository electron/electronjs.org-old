...
the [remote](http://electron.atom.io/docs/v0.30.1/api/remote) module, and showing it when the user right clicks
the page:
...
[MenuItem](http://electron.atom.io/docs/v0.30.1/api/menu-item), the usage can be referenced above.
