...
Emitted when a [browserWindow](http://electron.atom.io/docs/v0.30.1/api/browser-window-ko) gets blurred.
...
Emitted when a [browserWindow](http://electron.atom.io/docs/v0.30.1/api/browser-window-ko) gets focused.
...
* `event` Event
* `webContents` [WebContents](http://electron.atom.io/docs/v0.30.1/api/browser-window-ko#class-webcontents)
* `url` String
