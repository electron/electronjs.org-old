...
[Frameless Window](http://electron.atom.io/docs/v0.26.0/api/frameless-window) API.
...
* `options` Object
  ...
  * `icon` [NativeImage](http://electron.atom.io/docs/v0.26.0/api/native-image) - The window icon, when omitted on
    Windows the executable's icon would be used as window icon
  * `show` Boolean - Whether window should be shown when created
  * `frame` Boolean - Specify `false` to create a
    [Frameless Window](http://electron.atom.io/docs/v0.26.0/api/frameless-window)
  ...
  * `transparent` Boolean - Makes the window [transparent](http://electron.atom.io/docs/v0.26.0/api/frameless-window)
...
[NativeImage](http://electron.atom.io/docs/v0.26.0/api/native-image) that stores data of the snapshot. Omitting the
`rect` would capture the whole visible page.

**Note:** Be sure to read documents on remote buffer in
[remote](http://electron.atom.io/docs/v0.26.0/api/remote) if you are going to use this API in renderer
process.
...
* `overlay` [NativeImage](http://electron.atom.io/docs/v0.26.0/api/native-image) - the icon to display on the bottom
