...
obtained by subscribing to [`found-in-page`](http://electron.atom.io/docs/v0.36.10/api/web-view-tag#event-found-in-page) event.

### `<webview>.stopFindInPage(action)`

* `action` String - Specifies the action to take place when ending
  [`<webview>.findInPage`](http://electron.atom.io/docs/v0.36.10/api/web-view-tag#webviewtagfindinpage) request.
...
See [webContents.send](http://electron.atom.io/docs/v0.36.10/api/web-contents#webcontentssendchannel-args) for
examples.
...
See [webContents.sendInputEvent](http://electron.atom.io/docs/v0.36.10/api/web-contents##webcontentssendinputeventevent)
for detailed description of `event` object.

### `<webview>.getWebContents()`

Returns the [WebContents](http://electron.atom.io/docs/v0.36.10/api/web-contents) associated with this `webview`.
