...
you can use [webContents.executeJavascript](http://electron.atom.io/docs/v0.37.2/api/web-contents#webcontentsexecutejavascriptcode-usergesture).
...
Returns the [`BrowserWindow`](http://electron.atom.io/docs/v0.37.2/api/browser-window) object to which this web page
belongs.

### `remote.getCurrentWebContents()`

Returns the [`WebContents`](http://electron.atom.io/docs/v0.37.2/api/web-contents) object of this web page.
