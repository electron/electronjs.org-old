...
Emitted when a [browserWindow](http://electron.atom.io/docs/v0.37.2/api/browser-window) gets blurred.
...
Emitted when a [browserWindow](http://electron.atom.io/docs/v0.37.2/api/browser-window) gets focused.
...
Emitted when a new [browserWindow](http://electron.atom.io/docs/v0.37.2/api/browser-window) is created.
...
* `menu` [Menu](http://electron.atom.io/docs/v0.37.2/api/menu)

Sets the application's [dock menu][dock-menu].

### `app.dock.setIcon(image)` _OS X_

* `image` [NativeImage](http://electron.atom.io/docs/v0.37.2/api/native-image)
