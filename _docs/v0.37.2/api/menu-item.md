...
[`menu`](http://electron.atom.io/docs/v0.37.2/api/menu).

See [`menu`](http://electron.atom.io/docs/v0.37.2/api/menu) for examples.
...
* `options` Object
  ...
  * `label` String
  * `sublabel` String
  * `accelerator` [Accelerator](http://electron.atom.io/docs/v0.37.2/api/accelerator)
  * `icon` [NativeImage](http://electron.atom.io/docs/v0.37.2/api/native-image)
  * `enabled` Boolean
  * `visible` Boolean
  * `checked` Boolean
