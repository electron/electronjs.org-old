...
See [WebContents.send](http://electron.atom.io/docs/v0.34.0/api/web-contents#webcontentssendchannel-args) for
examples.
...
See [WebContents.sendInputEvent](http://electron.atom.io/docs/v0.34.0/api/web-contents##webcontentssendinputeventevent)
