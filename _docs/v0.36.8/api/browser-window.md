...
[Frameless Window](http://electron.atom.io/docs/v0.36.8/api/frameless-window) API.
...
* `options` Object
  ...
  * `icon` [NativeImage](http://electron.atom.io/docs/v0.36.8/api/native-image) - The window icon, when omitted on
  ...
  * `frame` Boolean - Specify `false` to create a
    [Frameless Window](http://electron.atom.io/docs/v0.36.8/api/frameless-window). Default is `true`.
  ...
  * `transparent` Boolean - Makes the window [transparent](http://electron.atom.io/docs/v0.36.8/api/frameless-window).
    Default is `false`.
...
* `preload` String - Specifies a script that will be loaded before other
  ...
  [here](http://electron.atom.io/docs/v0.36.8/api/process#event-loaded).
* `session` [Session](http://electron.atom.io/docs/v0.36.8/api/session#class-session) - Sets the session used by the
...
* `webContents` [WebContents](http://electron.atom.io/docs/v0.36.8/api/web-contents)
...
See the [`webContents` documentation](http://electron.atom.io/docs/v0.36.8/api/web-contents) for its methods and
events.
...
[NativeImage](http://electron.atom.io/docs/v0.36.8/api/native-image) that stores data of the snapshot. Omitting
...
* `overlay` [NativeImage](http://electron.atom.io/docs/v0.36.8/api/native-image) - the icon to display on the bottom
...
* `Button` Object
  * `icon` [NativeImage](http://electron.atom.io/docs/v0.36.8/api/native-image) - The icon showing in thumbnail
    toolbar.
  * `click` Function
