...
redirect_from:
    ...
    - /docs/v1.0.1/development/build-system-overview/
    - /docs/v1.1.0/development/build-system-overview/
    - /docs/v1.1.1/development/build-system-overview/
    - /docs/v1.1.2/development/build-system-overview/
