...
[`menu`](http://electron.atom.io/docs/v0.36.11/api/menu).

See [`menu`](http://electron.atom.io/docs/v0.36.11/api/menu) for examples.
...
* `options` Object
  ...
  * `icon` [NativeImage](http://electron.atom.io/docs/v0.36.11/api/native-image)
  * `enabled` Boolean
  * `visible` Boolean
  * `checked` Boolean
